...
const Upload = () => {
  return (
    <div className='pb-16'>
        {/*title*/}
        <h1 className='text-center text-2xl md:text-3xl lg:text-4xl font-semibold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent py-6 md:py16'>See the magic. Try now</h1>
